  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const signupData = {
        ...
        userRole: formData.role === "trainer" ? "Trainer" : "Member"
      };

      // Add trainer-specific data if applicable
      if (formData.role === "trainer") {
        signupData.specialization = formData.specialization;
        signupData.experienceYears = parseInt(formData.experience);
        signupData.salary = parseFloat(formData.salary);
      }

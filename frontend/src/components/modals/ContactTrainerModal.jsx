...
const ContactTrainerModal = ({ isOpen, onClose, trainer, onSend, loading, error }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70">
      <div className="bg-white rounded-xl shadow-lg p-8 w-full max-w-md relative" aria-live="polite">
        <button
          onClick={onClose}
        ...
        >
          {loading ? <span className="flex items-center justify-center"><span className="loader mr-2"></span> Sending...</span> : "Send Message"}
        </button>
      </div>
    </div>
  );

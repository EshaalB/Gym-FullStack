...
-- Add processedBy column to Payment table
ALTER TABLE Payment ADD processedBy INT NULL;
-- Optionally, add a foreign key constraint for processedBy
-- ALTER TABLE Payment ADD CONSTRAINT FK_Payment_ProcessedBy FOREIGN KEY (processedBy) REFERENCES gymUser(userId);

-- Create UserWorkoutPlans table
CREATE TABLE UserWorkoutPlans (
    userId INT NOT NULL,
    planId INT NOT NULL,
    assignedDate DATETIME DEFAULT GETDATE (),
    PRIMARY KEY (userId, planId),
    FOREIGN KEY (userId) REFERENCES gymUser (userId),
...
VALUES (1, 6, 'Fat Loss Beginner', 4),
    (
        2,
        6,
